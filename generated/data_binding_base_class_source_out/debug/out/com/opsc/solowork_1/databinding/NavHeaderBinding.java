...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView tvNavUserEmail,
      @NonNull TextView tvNavUserName) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderBinding((LinearLayout) rootView, tvNavUserEmail, tvNavUserName);
    }
