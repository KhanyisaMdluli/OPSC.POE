...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnDelete,
      @NonNull CheckBox cbTask, @NonNull TextView tvDescription, @NonNull TextView tvDueDate,
      @NonNull TextView tvPriority, @NonNull TextView tvTitle) {
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskBinding((MaterialCardView) rootView, btnDelete, cbTask, tvDescription,
          tvDueDate, tvPriority, tvTitle);
    }
